...
nav_button("← Back to Results", "pages/2_Results.py", key="nav_walkthrough_to_results")
show_logo()
...
""")
nav_button("Open Song X-Ray →", "pages/4_Song_XRay.py", key="nav_walkthrough_xray_1")
...
""")
nav_button("Open Moment Matcher →", "pages/5_Moment_Matcher.py", key="nav_walkthrough_mm_1")
...
nav_button("Open Ask the DJ →", "pages/6_Ask_The_DJ.py", key="nav_walkthrough_dj_1")
...
with st.expander("Direct links to the other states (for this walkthrough only)"):
    ...
    with cta_cols[0]:
        nav_button("Song X-Ray", "pages/4_Song_XRay.py", key="nav_walkthrough_xray_2")
        st.caption("A song's structural anatomy, fingerprints, and DNA in one place.")
    with cta_cols[1]:
        nav_button("Moment Matcher", "pages/5_Moment_Matcher.py", key="nav_walkthrough_mm_2")
        st.caption("Pick a moment, get ranked matches on any facet, with explanations.")
    with cta_cols[2]:
        nav_button("Ask the DJ", "pages/6_Ask_The_DJ.py", key="nav_walkthrough_dj_2")
